...
export const MOCK_PLACES: Place[] = [
  { id: 'place1', name: 'Club Fama', address: 'Rua Augusta, 600', category: 'club', followers: 1280, tags: ['Eletronica', 'House', 'Comercial'], description: 'Pista cheia, DJs convidados e noite com energia alta.', location: { latitude: -23.561, longitude: -46.656 }, activePosts: 14, activeUsers: 87, thumbnail: 'https://images.unsplash.com/photo-1566417713940-fe7c737a9ef2?w=400&q=80' },
  { id: 'place2', name: 'Bar do Victor', address: 'Av. Paulista, 1000', category: 'bar', followers: 640, tags: ['Bar', 'Drinks', 'Happy hour'], description: 'Bar urbano para encontros, drinks e esquenta antes da festa.', location: { latitude: -23.558, longitude: -46.660 }, activePosts: 6, activeUsers: 32, thumbnail: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400&q=80' },
  { id: 'place3', name: 'D-Edge', address: 'Av. Olga, 170', category: 'club', followers: 4100, tags: ['Techno', 'House', 'After'], description: 'Referencia de musica eletronica com noites longas e lineups fortes.', location: { latitude: -23.545, longitude: -46.643 }, activePosts: 31, activeUsers: 210, thumbnail: 'https://images.unsplash.com/photo-1574391884720-bbc3740c59d1?w=400&q=80' },
  { id: 'place4', name: 'Outs Club', address: 'R. Barra Funda, 969', category: 'club', followers: 930, tags: ['Rock', 'Indie', 'Alternativo'], description: 'Casa alternativa com pista, shows e publico fiel.', location: { latitude: -23.572, longitude: -46.648 }, activePosts: 9, activeUsers: 63, thumbnail: 'https://images.unsplash.com/photo-1571266028243-d220c6a6cb94?w=400&q=80' },
];
